...
//! * [`search`] — Search engine abstractions including the [`search::Clock`]
//!   trait for deterministic time in tests.
...
pub use search::{score, score_with_system_time, Clock, SystemClock};
